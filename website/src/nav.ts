...
export const nav: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/components/action-area', label: 'Action Area', keywords: '動作區 action area 底部 操作區', soon: true },
      { to: '/components/avatar', label: 'Avatar', keywords: '頭像 大頭貼 使用者', soon: true },
      { to: '/components/bottom-bar', label: 'Bottom Bar', keywords: '底部導航 tab bar 導覽列', soon: true },
