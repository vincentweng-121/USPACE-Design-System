      ...
      {tab === 'design' && (
        <div>
          ...
          <section className="section">
            ...
            <PendingImage expects="text-field-variant" note="一張圖並排所有變體，圖上標號 1、2、3…，下方用 NumberedCaptions 逐項說明。" />
          </section>
          ...
          <section className="section">
            ...
            <PendingImage expects="text-field-measurements" note="標出高度、內距、間距的量測圖。" />
            <div style={{ fontSize: 16, color: 'var(--text-secondary)', lineHeight: 1.8 }}>
              <ul style={{ paddingLeft: 20 }}>
          ...
          <section className="section">
            ...
            <Pending
              what="Do / Don't 圖例"
              why="Button 頁是三組對照圖（text-field-do-caseN / text-field-dont-caseN）。這裡的 Figma artboard 尚未產出。"
            />
            <div style={{ fontSize: 16, color: 'var(--text-secondary)', lineHeight: 1.8 }}>
              <ul style={{ paddingLeft: 20 }}>
